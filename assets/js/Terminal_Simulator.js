function START_UBUNTU_TERMINAL() {
    ...
    let CURRENT_USER = USERS['sethuaung'];       // {root:root, sethuaung:sethuaung, felixent:felixent}
    ...
    // INITIALIZE //
    function InitUser() {
        return {'root': new User('root'), 'sethuaung': new User('sethuaung'), 'felixent': new User('felixent')};
    }
    ...
    function InitFileSystem() {
        ...
        home.addDirectory(new Directory('sethuaung', 'sethuaung', DEFAULT_DIR_PERMISSION, home));
        home.addDirectory(new Directory('felixent', 'felixent', DEFAULT_DIR_PERMISSION, home));

        const sethuaung = home.getChildren('sethuaung');
        sethuaung.addDirectory(new Directory('code', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('this', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('fun', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('...is', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('just', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('..for', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('.-.for', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('.testing', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('I', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('.will', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addDirectory(new Directory('.delete', 'sethuaung', DEFAULT_DIR_PERMISSION, sethuaung));
        sethuaung.addFile(new File('later', 'sethuaung', DEFAULT_FILE_PERMISSION, sethuaung));
        sethuaung.addFile(new File('GitHub', 'sethuaung', '007', sethuaung));
        sethuaung.getChildren('GitHub').setFileContent("https://sethuaung.github");
        sethuaung.getChildren('GitHub').setFileContent(".io/", 'a');
        sethuaung.addFile(new File('.hidden', 'sethuaung', DEFAULT_FILE_PERMISSION, sethuaung));
        sethuaung.getChildren('.hidden').setFileContent("you cant possibly read this, or can you 👀");

        const felixent = home.getChildren('felixent');
        felixent.addDirectory(new Directory('ex', 'felixent', DEFAULT_DIR_PERMISSION, felixent));
        felixent.getChildren('ex').addDirectory(new Directory('me', 'felixent', DEFAULT_DIR_PERMISSION, felixent.getChildren('ex')));
        felixent.addFile(new File('MKNQ', 'felixent', DEFAULT_FILE_PERMISSION, felixent));
        felixent.getChildren('MKNQ').setFileContent("still a mystery...");

        const code = sethuaung.getChildren('code');
        code.addDirectory(new Directory('is', 'sethuaung', DEFAULT_DIR_PERMISSION, code));
        code.addDirectory(new Directory('is', 'sethuaung', DEFAULT_DIR_PERMISSION, code));  // would not add
        code.getChildren('is').addFile(new File('fun', 'sethuaung', DEFAULT_FILE_PERMISSION, code.getChildren('is')));
        code.getChildren('is').getChildren('fun').setFileContent("code is fun");

        code.addFile(new File('goal', 'sethuaung', DEFAULT_FILE_PERMISSION, code));
        code.addFile(new File('goal', 'sethuaung', DEFAULT_FILE_PERMISSION, code));         // would not add
